...
for N in $(seq $Ninicio $Npaso $Nfinal);do
	...
	time1=$(valgrind -q --tool=cachegrind --cachegrind-out-file=multN.out.dat --I1=8192,1,64 --D1=8192,1,64 --LL=8388608,1,64 ./multN $N | grep 'time' | awk '{print $3}')
...
for N in $(seq $Ninicio $Npaso $Nfinal);do
	...
	time2=$(valgrind -q --tool=cachegrind --cachegrind-out-file=multTr.out.dat --I1=8192,1,64 --D1=8192,1,64 --LL=8388608,1,64 ./multTr $N | grep 'time' | awk '{print $3}')
...
for N in $(seq $Ninicio $Npaso $Nfinal);do
	...
	time1=$(grep $N $fDAT1 | awk -v var="$N" 'var==$1 {print $2}')
  matN1=$(grep $N $fDAT1 | awk -v var="$N" 'var==$1 {print $3}')
  matN2=$(grep $N $fDAT1 | awk -v var="$N" 'var==$1 {print $4}')
  time2=$(grep $N $fDAT2 | awk -v var="$N" 'var==$1 {print $2}')
  matTr1=$(grep $N $fDAT2 | awk -v var="$N" 'var==$1 {print $3}')
  matTr2=$(grep $N $fDAT2 | awk -v var="$N" 'var==$1 {print $4}')
